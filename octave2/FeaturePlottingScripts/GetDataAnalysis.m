function DataOut = GetDataAnalysis( FilePath = "/media/ahmed/5CFEF97DFEF9502E/study/Graduation_Project/Octave/[2014-04-17] Hemaly's Data/[T][2014-04-17 23-06-15] Ahmed Hemaly.csv",
                                    RawDataFunctionsPath = "/media/ahmed/5CFEF97DFEF9502E/study/Graduation_Project/Octave/DetectorGUI/Classifiers/RawDataFunctions",
                                    %ChannelName = "FC6",
                                    Mu_Min = 9,     %10
                                    Mu_Max = 11,    %12
                                    Beta_Min = 15,  %16
    ...
    for f = 1:nChannels
            ...
            for k =1:length(HDR.TRIG)
                ...
                % Forcing the curve to start from 0
                Data = Data - Data(1);
    ...
    DataOut.Mu_Min = Mu_Min;
    DataOut.Mu_Max = Mu_Max;
    DataOut.Beta_Min = Beta_Min;
    DataOut.Beta_Max = Beta_Max;
end
